...
class Ftp
{
    ...
    protected $localExportFolder = '/InetSys/files/export';
    ...
    public function __construct($params)
    {
        ...
        $this->log = Logger::getInstance('ftp');
        if (!empty($params)) {
    ...
    {
        if (file_exists($localPath)) {
            $filePath = $_SERVER['DOCUMENT_ROOT'] . '/InetSys/tmpFilesFtp/' . $additionalPath . '/' . basename($ftpPath);
            $fp = fopen($filePath, 'w');
            fwrite($fp, 'put');
            fclose($fp);
            exec(
    ...
    {
        $dirPath = $_SERVER['DOCUMENT_ROOT'] . '/InetSys/tmpFilesFtp/' . $additionalPath;
    ...
    {
        $files = @scandir($_SERVER['DOCUMENT_ROOT'] . '/InetSys/tmpFilesFtp/' . $additionalPath);
    ...
    {
        if (($files = @scandir($_SERVER['DOCUMENT_ROOT'] . '/InetSys/tmpFilesFtp/' . $additionalPath))
