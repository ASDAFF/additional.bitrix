...
Class inetsys_additionalbitrix extends CModule{
	var	$MODULE_ID = 'inetsys.additionalbitrix';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("INETSYS_ADDITIONALBITRIX_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("INETSYS_ADDITIONALBITRIX_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("INETSYS_ADDITIONALBITRIX_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("INETSYS_ADDITIONALBITRIX_PARTNER_URI");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("INETSYS_ADDITIONALBITRIX_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("INETSYS_ADDITIONALBITRIX_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("INETSYS_ADDITIONALBITRIX_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>